> [!NOTE]
> This repository is a community-maintained continuation based on [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen), which was archived by its original maintainer.
> The goal is to continue maintenance, bug fixes, packaging, and user-requested improvements while preserving the original MIT license and attribution.
> Installation links below may still point to the original project until this repository publishes its own releases.
